...
module.exports = {
    ...
    add(req,res,next){
        ...
        const new_query = "MATCH (n:chatmessage) WHERE ID(n) = toInteger($message) MERGE (u:chatresource {title:$title, url: $url,description:$description}) CREATE (u)-[:MENTIONED_IN]->(n)"
